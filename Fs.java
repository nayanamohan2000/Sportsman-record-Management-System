...
class records{
static String name,gender,mail_id,city,sportsman_id;
}
class node{
int [] a=new int[5];
int size;
...
public void search(int key)
	{
		  ...
		  {
			  flg = 1;
			  System.out.print("The SPORTSMAN ID ");
...
public void insert(int key)
{
	...
	promote(leaf,key,null);
	 System.out.print("---------------\n");
	try{  
                 File fle = new File("C:\\Users\\Nayana M\\Documents\\NetBeansProjects\\fs\\traversal.txt");
	  ...
	  System.out.print("---------------- \n");
              try{ 
                  FileWriter fw=new FileWriter("C:\\Users\\Nayana M\\Documents\\NetBeansProjects\\fs\\traversal.txt",true);
                    fw.write("-----------------\n");
                    fw.close();
                }
                catch(Exception e)
...
void traverse(node ptr){
    ...
    {
        System.out.print(ptr.a[i]+" ");
      try{  FileWriter fw=new FileWriter("C:\\Users\\Nayana M\\Documents\\NetBeansProjects\\fs\\traversal.txt",true);
        fw.write(ptr.a[i]+" ");
        fw.close();
    }
...
no1=0;
try {
          File fle = new File("C:\\Users\\Nayana M\\Documents\\NetBeansProjects\\register.txt");
          if (fle.createNewFile()){
            System.out.println("File is created!");
            }else{
            System.out.println("File already exists.");
...
BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\Nayana M\\Documents\\NetBeansProjects\\register.txt"));
String line;
...
static String name,gender,mail_id,city,count;
...
for(int i=0;i<no;i++)
recs[i]=new records();
BufferedReader bbr = new BufferedReader(new FileReader("C:\\Users\\Nayana M\\Documents\\NetBeansProjects\\register.txt"));
for(int i=0;i<no;i++)
{
...
try {
FileWriter fw=new FileWriter("C:\\Users\\Nayana M\\Documents\\NetBeansProjects\\register.txt",true);
fw.write(""+key);
fw.write("|");
fw.write(name);
fw.write("|");
...
b.search(key);
bbr=new BufferedReader(new FileReader("C:\\Users\\Nayana M\\Documents\\NetBeansProjects\\register.txt"));
for(int i=0;i<no;i++)
{
String lineRead=bbr.readLine();
